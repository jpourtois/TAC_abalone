...
appendixC_randomEnv <- function(){
  ...
  env1 <- function_analysis(h = 0.09, Allee = TRUE, corrK = corrK, rep = 10) # Start at 12:45
  env1$rand <- '1'
  
  env1b <- function_analysis(h = 0.12, Allee = TRUE, corrK = corrK, rep = 10)
  env1b$rand <- '1b'
  ...
  env2 <- function_analysis(h = 0.09, Allee = TRUE, corrK = corrK, rep = 10)
  env2$rand <- '2'
  
  env2b <- function_analysis(h = 0.12, Allee = TRUE, corrK = corrK, rep = 10)
  env2b$rand <- '2b'
  ...
  env3 <- function_analysis(h = 0.09, Allee = TRUE, corrK = corrK, rep = 10)
  env3$rand <- '3'
  
  env3b <- function_analysis(h = 0.12, Allee = TRUE, corrK = corrK, rep = 10)
  env3b$rand <- '3b'
